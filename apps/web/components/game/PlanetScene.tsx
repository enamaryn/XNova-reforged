...
export function PlanetScene({
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl border border-slate-800/80 bg-slate-950/60 p-6 shadow-[0_0_40px_rgba(2,132,199,0.12)]">
      ...
      <div className="mt-8 flex items-center gap-6">
        <Link
          href={actionHref}
          className="group relative h-36 w-36"
        >
