export const SHIPS = {
    ...
    204: {
        ...
        stats: { hull: 4000, shield: 10, weapon: 50 },
        speed: 12500,
        cargo: 50,
        consumption: 20,
        rapidfire: { 210: 5, 401: 10 },
    ...
    211: {
        ...
        cargo: 500,
        consumption: 1000,
        rapidfire: { 401: 20, 402: 20, 403: 10 },
...
function getShipDriveType(shipId) {
    if ([202, 204, 210].includes(shipId))
        return 'combustion';
    if ([203, 205, 208, 209, 211].includes(shipId))
        return 'impulse';
    if ([206, 207, 213, 214, 215].includes(shipId))
        return 'hyperspace';
    return 'combustion';
}
