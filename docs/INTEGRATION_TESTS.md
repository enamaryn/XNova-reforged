...
Les tests d'intégration (`apps/api/test/integration/**/*.spec.ts`) vérifient l'ensemble des endpoints critiques de l'API. Ils s'appuient sur une vraie base PostgreSQL + Redis pour reproduire la logique métier du backend.
